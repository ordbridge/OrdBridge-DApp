...
const variants = {
  ...
  outline: {
    deep_purple_A200_d3: 'border-deep_purple-A200_d3 border-solid text-deep_purple-A100_cc',
    white_A700_19: 'border bg-gradient  border border-solid border-white-A700_19 text-white-A700',
    ...
    deep_purple_A200_cc: 'border border-deep_purple-A200_cc border-solid text-white-A700'
  }
};

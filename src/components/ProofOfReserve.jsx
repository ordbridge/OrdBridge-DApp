  ...
  useEffect(() => {
    ethContractHandler.methods.tokenContracts(token.token).call((err, result) => {
      ...
      if (result !== '0x0000000000000000000000000000000000000000') {
        ...
        tokenContractHandler.methods.totalSupply().call((err, result) => {
          if (result) {
            let supply = ethWeb3.utils.fromWei(result, 'ether');
    ...
    avaxContractHandler.methods.tokenContracts(token.token).call((err, result) => {
      ...
      if (result !== '0x0000000000000000000000000000000000000000') {
        ...
        tokenContractHandler.methods.totalSupply().call((err, result) => {
          if (result) {
            let supply = avaxWeb3.utils.fromWei(result, 'ether');
  ...
  return (
    <div className="min-w-full">
      ...
      <div className="pt-4 min-w-full">
        ...
        <Text className="m-0 p-0 text-[32px] text-white-A700" size="txtSyneBold40">
